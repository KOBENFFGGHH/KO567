...
local Library = Update:Window("KOBEN hub ","",Enum.KeyCode.RightControl);
    ...
    while true do
        if _G.FastAttack then
            pcall(function()
                ...
                CombatFramework.activeController.timeToNextBlock = 1
                CombatFramework.activeController.focusStart = 1
...
Cr:Label("เเปลไทยโดย KOBEN")
Cr:Line()
Cr:Label("คนทำKOBEN hub")
Cr:Line()
